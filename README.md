...
shared.LoaderTitle = "|PremiumScript|Load";
...
local v15 = v14:CreateWindow({
    Title = "TcytherHub|PREMIUM|",
    SubTitle = "Blox Fruit-by:G90,Nolegiaden",
    TabWidth = 160,
    Theme = "Dark",
    Acrylic = false,
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("https://discord.gg/Sskared squad");
    end
});
...
local v52 = v16.Main:AddToggle("ToggleHakiFortress", {
    Title = "Auto On Haki on Tower SEA3",
    Description = "",
    Default = false
});
    ...
    spawn(function()
        pcall(function()
            while wait() do
                ...
                v485:SetDesc("HAVE " .. tostring(v768) .. " BONEs");
            end
        end);
    end);
...
if Sea3 then
    ...
    local v515 = v16.Sea:AddToggle("AutoFindFrozen", {
        ...
        Description = "need 5 people to go",
        Default = false
    });
    ...
    local v517 = v16.Sea:AddToggle("AutoComeHydra", {
        Title = "pull the heart back Hydra",
        Description = "",
        Default = false
    });
...
if Sea3 then
    ...
    spawn(function()
        pcall(function()
            while wait() do
                v532:SetDesc("mysterious island: " .. MirageStatus .. " | FULLMOON: " .. FullMoonStatus);
            end
        end);
    end);
    v16.Sea:AddButton({
...
local v144 = v16.Race:AddToggle("ToggleHumanandghoul", {
    Title = "auto complete raid mission[Human/Ghoul]",
    Description = "",
    Default = false
});
...
local v145 = v16.Race:AddToggle("ToggleAutotrial", {
    Title = "auto complete raid mission",
    Description = "",
    Default = false
});
...
local v56 = v16.Race:AddSection("farmv4");
local v147 = v16.Race:AddToggle("ToggleFarmRace", {
    Title = "auto AWKv4 farm",
    Description = "",
    Default = false
});
local v148 = false;
...
local v166 = v16.Sea:AddParagraph({
    Title = "auto Draco V4 (Sớm Ra)",
    Content = ""
});
local v167 = v16.Sea:AddToggle("ToggleTrialTeleport", {
    Title = "fly to Trial Draco",
    Description = "",
    Default = false
});
